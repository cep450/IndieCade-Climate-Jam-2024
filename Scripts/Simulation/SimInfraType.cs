...
[System.Flags]
	...
	public static SimInfraType [] types = {
		...
		GD.Load<SimInfraType>("res://Resources/InfraTypes/concrete.tres")
	};
	...
	[ExportGroup("Path Finding Info")]
	//// if this is a destination, what type is it?
	[Export] public DestinationType destinationType; 
	//// what transport modes can use this infrastructure?
	[Export] public SimVehicleType.TransportMode transportModes; 
	//// connects on corners between tiles
	[Export] public bool connectsCorners;	
	//// connects on borders between tiles 
	[Export] public bool connectsBorders; 	
	//// connects from the center to its edges
	[Export] public bool connectsCenter; 	
	//// infra applies its weight effects to all PathVertexes on the tile 
	[Export] public bool affectsAllVertices; 
